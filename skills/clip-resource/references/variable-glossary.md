...
Output from a quoted instruction enters the `.slipbox/humanize-checklist.json` workflow because the agent synthesized or rewrote it; bare-variable output never does, since there is nothing synthesized to check.
